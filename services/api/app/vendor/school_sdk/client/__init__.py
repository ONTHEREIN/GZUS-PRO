...
import typing as t
import requests
from app.vendor.school_sdk.client.api.class_schedule import ScheduleClass
from app.vendor.school_sdk.client.api.score import Score
from app.vendor.school_sdk.client.api.user_info import Info
from app.vendor.school_sdk.client.utils import user_is_login
from app.vendor.school_sdk.config import URL_ENDPOINT
from app.vendor.school_sdk.client.api.schedules import Schedule
from app.vendor.school_sdk.client.exceptions import LoginException
import time
from app.vendor.school_sdk.client.api.login import ZFLogin
from app.vendor.school_sdk.client.base import BaseUserClient
