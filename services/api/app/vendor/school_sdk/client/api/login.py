...
'''
from app.vendor.school_sdk.client.exceptions import LoginException, RTKException
from app.vendor.school_sdk.client.api import BaseCrawler
from app.vendor.school_sdk.PyRsa.pyb64 import Base64
from app.vendor.school_sdk.PyRsa import RsaKey
...
class ZFLogin(BaseCrawler):
    ...
    def verification_captcha(self) -> bool:
        """滑块验证
            ...
            3. 发起验证请求
        """
        from app.vendor.school_sdk.check_code import ZFCaptchaDistinguish
        from app.vendor.school_sdk.check_code.type import captcha_func
        rtk = self._get_rtk()
    ...
    def verification_kaptcha(self) -> str:
        """图形验证码识别"""
        from app.vendor.school_sdk.check_code import ZFCaptchaDistinguish
        from app.vendor.school_sdk.check_code.type import kaptcha_func
        # 下载验证码
